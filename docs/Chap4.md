...
\begin{table}[!h]
\centering
\caption{(\#tab:tab1)All possible treatment conditions for the three-factor popcorn study.}
\centering
...
![(\#fig:fig1)Individual value plot of the PopRate (100 $	imes$ count of popped kernels/total kernels) for each Brand and cooking Time factor-level combination. Points have jittering (small fluctuations) so that all values are visible.](Chap4_files/figure-latex/fig1-1.pdf) 
...
\begin{table}[!h]
\centering
\caption{(\#tab:tab3) Popcorn study sample means: the mean \texttt{PopRate} (per 100 kernels) for each of the nine meaningful groups of sample data.}
\centering
...
![(\#fig:fig42)Side-by-side boxplots and an interaction plot of the PopRate for each Brand and cooking Time factor-level combination.](Chap4_files/figure-latex/fig42-1.pdf) 
...
\caption{Main effect plots and interaction plots for a three-factor ANOVA.}(\#fig:fig43)
\end{figure}
...
\begin{table}[!h]
\centering
\caption{(\#tab:tab44)Strength of paper towels (grams of weight added before the towel broke). The \texttt{Brand} factor has two levels: $i = 1$ represents Comfort and $i = 2$ represents Decorator towels. The \texttt{Water} factor has three levels: $j = 1, 2,$ and 3 represent 0 drops, 5 drops, and 15 drops of water, respectively.}
\centering
...
\begin{table}[!h]
\centering
\caption{(\#tab:tab45) Average \texttt{Strength} of paper towels (grams).}
\centering
...
\caption{Two-way factorial diagram.}(\#fig:fig44)
\end{figure}
...
\begin{table}[!h]
\centering
\caption{(\#tab:tab6)Interaction effects.}
\centering
\begin{tabular}[t]{lccc}
\toprule
  & 0 & 5 & 15\\
...
\begin{table}[!h]
\centering
\caption{(\#tab:tab47)Interaction effects.}
\centering
\begin{tabular}[t]{ccc}
\toprule
  &   &  \\
...
\begin{table}[!h]
\centering
\caption{(\#tab:tab48)Two-way ANOVA table.}
\centering
\begin{tabular}[t]{lcccc}
\toprule
...
\begin{table}[!h]
\centering
\caption{(\#tab:tab9)Three-way ANOVA table.}
\centering
\begin{tabular}[t]{lcccc}
\toprule
Source & df & SS & MS & $F$-Statistic\\
