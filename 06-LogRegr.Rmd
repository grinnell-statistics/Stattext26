...
```{r fig61, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Picture of the space shuttle Challenger just after ignition. Each solid rocket booster had six O-rings, two at each field joint. The O-rings at the right aft field joint failed."}
...
```{r fig63, warning=FALSE, echo=FALSE, fig.width=6, fig.height=4, message=FALSE, fig.cap="Space shuttle data with a simple linear regression model and a logistic regression model."}
...
```{r fig64, echo=FALSE, fig.width=6, fig.height=4, message=FALSE, fig.cap="A scatterplot of the residuals from the space shuttle logistic regression model and a sample of what a scatterplot of normally distributed residuals might look like."}
...
```{r fig65, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Minitab output for the space shuttle study."}
...
```{r fig67, echo=FALSE, fig.width=6, fig.height=4, message=FALSE, fig.cap=" A scatterplot of the observed data and estimated probabilities for both round cells (Concave= 0) and concave cells (Concave= 1)."}
library(tidyr)
...
```{r fig68, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Minitab output showing measures of association for the space shuttle data."}
...
```{r fig69, echo=FALSE, fig.width=6, fig.height=4, message=FALSE, fig.cap="A logistic regression model, with $\\hat \\pi_i$ estimated from Equation (6.8) using maximum likelihood estimates, plotted with the observed probability of malignancy for the grouped data in Table 6.3."}
# fit model
...
```{r fig610, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Minitab output for the Cancercells study"}
...
```{r fig611, echo=FALSE, fig.width=6, fig.height=4, message=FALSE, fig.cap="Scatterplots of delta deviance, delta chi-square, and delta beta values versus the expected probabilities from the space shuttle data. Circled values represent launches at 75°F."}
library(patchwork)
...
```{r fig612, echo=FALSE, fig.width=6, fig.height=4, message=FALSE, fig.cap=" Scatterplots of delta chi-square and delta beta values versus leverage from the space shuttle data. The extreme value along the y-axis represents the launches at 75°F. There do not appear to be any extreme leverage values."}
library(ggplot2)
library(patchwork)
# fit regression
#df <- read.csv("Shuttle.csv", stringsAsFactors = FALSE)
