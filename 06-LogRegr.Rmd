...
```{r fig65, echo=FALSE, out.width="110%", fig.align="center", fig.cap="Software output showing the Wald statistic for the space shuttle study."}
...
```{r fig66, echo=FALSE, out.width="110%", fig.align="center", fig.cap="Software output showing the null and residual deviance for the space shuttle study."}
...
```{r fig67, echo=FALSE, out.width="110%", fig.align="center", fig.cap="A scatterplot of the observed data and the estimated probabilities for both round cells (Concave = 0) and concave cells (Concave = 1)."}
...
```{r fig68, echo=FALSE, out.width="110%", fig.align="center", fig.cap="Software output showing measures of association for the space shuttle data."}
...
```{r fig69, echo=FALSE, out.width="110%", fig.align="center", fig.cap="A logistic regression model, with $\\hat \\pi_i$ estimated from Equation (6.8) using maximum likelihood estimates, plotted with the observed probability of malignancy for the grouped data in Table 6.3."}
...
```{r fig612, echo=FALSE, out.width="80%", fig.align="center", fig.cap="Scatterplots of delta chi-square and delta beta values versus leverage from the space shuttle data. The extreme value along the y-axis represents the launches at 75°F. There do not appear to be any extreme leverage values."}
