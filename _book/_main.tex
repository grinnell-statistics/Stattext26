...
\textbf{\textcolor{blue}{Key Concept:}}
\textcolor{blue}{When the response in a regression model is binomial, $\pi_i = P(Y_i = 1)$ is the probability of a success (a launch has no O-ring damage at temperature $x_i$). In simple linear regression models with a binomial response,}
...
\textbf{\textcolor{blue}{Key Concept:}}
\textbackslash textcolor\{blue\}\{When a 95\% Wald confidence interval for the odds ratio does not contain 1, we reject the null hypothesis \(H_0: \beta_1 = 0\) (using an alpha-level of 0.05) and conclude that the odds of success do depend on the explanatory variable \(x_i\). If the interval does contain 1, we fail to reject \(H_0: \beta_1 = 0\).\}
...
\caption{Minitab output for the space shuttle study.}\label{fig:fig65}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/fig67-1.pdf}
\caption{\label{fig:fig67} A scatterplot of the observed data and estimated probabilities for both round cells (Concave= 0) and concave cells (Concave= 1).}
\end{figure}
...
\textbackslash textbf\{\textcolor{blue}{Key Concept:}\}
...
\caption{Minitab output showing measures of association for the space shuttle data.}\label{fig:fig68}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/fig69-1.pdf}
\caption{\label{fig:fig69}A logistic regression model, with \(\hat \pi_i\) estimated from Equation (6.8) using maximum likelihood estimates, plotted with the observed probability of malignancy for the grouped data in Table 6.3.}
\end{figure}
...
\caption{Minitab output for the Cancercells study}\label{fig:fig610}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/fig611-1.pdf}
\caption{\label{fig:fig611}Scatterplots of delta deviance, delta chi-square, and delta beta values versus the expected probabilities from the space shuttle data. Circled values represent launches at 75°F.}
\end{figure}
