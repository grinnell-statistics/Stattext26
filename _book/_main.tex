...
\makeatother
\usepackage{xcolor}
\usepackage[top=1in,bottom=1in,left=.92in,right=.92in,margin=1in]{geometry}
...
\section{Nonparametric Methods: Schistosomiasis}\label{nonparametric-methods-schistosomiasis}}
...
\hypertarget{section}{%
\subsection{\texorpdfstring{\textcolor{blue}{Investigation: Can a New Drug Reduce the Spread of Schistosomiasis?}}{}}\label{section}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Describing the Data}{ Describing the Data}}\label{describing-the-data}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Describing the Data}
...
\subsection{\texorpdfstring{\textcolor{blue}{Statistical Inference Through a Randomization Test}}{}}\label{section-1}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Conducting a Randomization Test by Hand}{ Conducting a Randomization Test by Hand}}\label{conducting-a-randomization-test-by-hand}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Conducting a Randomization Test by Hand}
...
\subsection{\texorpdfstring{\textcolor{blue}{ Performing a Randomization Test Using a Computer Simulation}}{}}\label{section-2}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Using Computer Simulations to Conduct a Hypothesis Test}{ Using Computer Simulations to Conduct a Hypothesis Test}}\label{using-computer-simulations-to-conduct-a-hypothesis-test}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Using Computer Simulations to Conduct a Hypothesis Test}
...
\subsection{\texorpdfstring{\textcolor{blue}{Two-Sided Tests}}{}}\label{section-3}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} A Two-Sided Hypothesis Test}{ A Two-Sided Hypothesis Test}}\label{a-two-sided-hypothesis-test}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} A Two-Sided Hypothesis Test}
...
\subsection{\texorpdfstring{\textcolor{blue}{What Can We Conclude from the Schistosomiasis Study?}}{}}\label{section-4}}
...
\subsection{\texorpdfstring{\textcolor{blue}{Permutation Tests versus Randomization Tests}}{}}\label{section-5}}
...
\subsubsection*{Age Discrimination Study}\label{age-discrimination-study}}
\addcontentsline{toc}{subsubsection}{Age Discrimination Study}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Is There Evidence of Age Discrimination?}{ Is There Evidence of Age Discrimination?}}\label{is-there-evidence-of-age-discrimination}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Is There Evidence of Age Discrimination?}
...
\subsection{\texorpdfstring{\textcolor{blue}{Permutation and Randomization Tests for Matched Pairs Designs}}{}}\label{section-6}}
...
\subsubsection*{Music and Relaxation}\label{music-and-relaxation}}
\addcontentsline{toc}{subsubsection}{Music and Relaxation}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Testing the Effect of Music on Relaxation}{ Testing the Effect of Music on Relaxation}}\label{testing-the-effect-of-music-on-relaxation}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Testing the Effect of Music on Relaxation}
...
\subsection{\texorpdfstring{\textcolor{blue}{The Bootstrap Distribution}}{}}\label{section-7}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Creating a Sampling Distribution and a Bootstrap Distribution}{ Creating a Sampling Distribution and a Bootstrap Distribution}}\label{creating-a-sampling-distribution-and-a-bootstrap-distribution}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Creating a Sampling Distribution and a Bootstrap Distribution}
...
\subsection{\texorpdfstring{\textcolor{blue}{Using Bootstrap Methods to Create Confidence Intervals}}{}}\label{section-8}}
...
\subsubsection*{Bootstrap t Confidence Intervals}\label{bootstrap-t-confidence-intervals}}
\addcontentsline{toc}{subsubsection}{Bootstrap t Confidence Intervals}
...
\subsubsection*{Bootstrap Percentile Confidence Intervals}\label{bootstrap-percentile-confidence-intervals}}
\addcontentsline{toc}{subsubsection}{Bootstrap Percentile Confidence Intervals}
...
\subsubsection*{When to Use Bootstrap Confidence Intervals}\label{when-to-use-bootstrap-confidence-intervals}}
\addcontentsline{toc}{subsubsection}{When to Use Bootstrap Confidence Intervals}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:}Estimating Salaries of Medical Faculty}{Estimating Salaries of Medical Faculty}}\label{estimating-salaries-of-medical-faculty}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:}Estimating Salaries of Medical Faculty}
...
\subsection{\texorpdfstring{\textcolor{blue}{Relationship Between the Randomization Test and the Two-Sample t-Test}}{}}\label{section-9}}
...
\subsection{\texorpdfstring{\textcolor{blue}{Wilcoxon Rank Sum Tests for Two Independent Samples}}{}}\label{section-10}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} \emph{Wilcoxon Rank Sum Tests}}{ Wilcoxon Rank Sum Tests}}\label{wilcoxon-rank-sum-tests}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} \emph{Wilcoxon Rank Sum Tests}}
...
\subsection{\texorpdfstring{\textcolor{blue}{Kruskal-Wallis Test for Two or More Independent Samples}}{}}\label{section-11}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Kruskal-Wallis Test}{ Kruskal-Wallis Test}}\label{kruskal-wallis-test}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Kruskal-Wallis Test}
...
\subsection{\texorpdfstring{\textcolor{blue}{Multiple Comparisons}}{}}\label{section-12}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Comparing Car Prices}{ Comparing Car Prices}}\label{comparing-car-prices}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Comparing Car Prices}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} The Least-Significant Differences Method and the Bonferroni Method}{ The Least-Significant Differences Method and the Bonferroni Method}}\label{the-least-significant-differences-method-and-the-bonferroni-method}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} The Least-Significant Differences Method and the Bonferroni Method}
...
\subsubsection*{Choosing a Critical Value}\label{choosing-a-critical-value}}
\addcontentsline{toc}{subsubsection}{Choosing a Critical Value}
...
\subsection{\texorpdfstring{\textcolor{blue}{Chapter Summary}}{}}\label{section-13}}
...
\subsubsection*{Endnotes}\label{endnotes}}
\addcontentsline{toc}{subsubsection}{Endnotes}
...
\section{Making Connections: The Two-Sample t-Test, Regression, and ANOVA}\label{making-connections-the-two-sample-t-test-regression-and-anova}}
...
\subsection{\texorpdfstring{\textcolor{blue}{ Investigation: Do Distracting Colors Influence the Time to Complete a Game?}}{}}\label{section-14}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Understanding the Study Design}{ Understanding the Study Design}}\label{understanding-the-study-design}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Understanding the Study Design}
...
\subsection{\texorpdfstring{\textcolor{blue}{ The Two-Sample t-Test to Compare Population Means}}{}}\label{section-15}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Statistical Models for the Two-Sample t-Test}{ Statistical Models for the Two-Sample t-Test}}\label{statistical-models-for-the-two-sample-t-test}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Statistical Models for the Two-Sample t-Test}
...
\subsubsection*{Model Assumptions for the Two-Sample t-Test}\label{model-assumptions-for-the-two-sample-t-test}}
\addcontentsline{toc}{subsubsection}{Model Assumptions for the Two-Sample t-Test}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Checking Assumptions for the t-Test}{ Checking Assumptions for the t-Test}}\label{checking-assumptions-for-the-t-test}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Checking Assumptions for the t-Test}
...
\subsection{\texorpdfstring{\textcolor{blue}{ The Regression Model to Compare Population Means}}{}}\label{section-16}}

\hypertarget{the-linear-regression-model}{%
\subsubsection*{The Linear Regression Model}\label{the-linear-regression-model}}
\addcontentsline{toc}{subsubsection}{The Linear Regression Model}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Calculating a Regression Model and Hypothesis Test for the Slope}{ Calculating a Regression Model and Hypothesis Test for the Slope}}\label{calculating-a-regression-model-and-hypothesis-test-for-the-slope}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Calculating a Regression Model and Hypothesis Test for the Slope}
...
\subsubsection*{Model Assumptions for Regression}\label{model-assumptions-for-regression}}
\addcontentsline{toc}{subsubsection}{Model Assumptions for Regression}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Checking Model Assumptions}{ Checking Model Assumptions}}\label{checking-model-assumptions}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Checking Model Assumptions}
...
\subsection{\texorpdfstring{\textcolor{blue}{ ANOVA to Compare Population Means}}{}}\label{section-17}}
...
\subsubsection{The ANOVA Model}\label{the-anova-model}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} The ANOVA Model}{ The ANOVA Model}}\label{the-anova-model-1}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} The ANOVA Model}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Estimating the Model Values}{ Estimating the Model Values}}\label{estimating-the-model-values}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Estimating the Model Values}
...
\subsubsection*{Model Assumptions for ANOVA}\label{model-assumptions-for-anova}}
\addcontentsline{toc}{subsubsection}{Model Assumptions for ANOVA}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Checking Assumptions}{ Checking Assumptions}}\label{checking-assumptions}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Checking Assumptions}
...
\subsection{\texorpdfstring{\textcolor{blue}{ Comparing Planned Variability to Random Variability}}{}}\label{section-18}}
...
\subsection{\texorpdfstring{\textcolor{blue}{ Random Sampling and Random Allocation}}{}}\label{section-19}}
...
\subsection{\texorpdfstring{\textcolor{blue}{ What Can We Conclude from the Game Study?}}{}}\label{section-20}}
...
\subsection{\texorpdfstring{\textcolor{blue}{ Normal Probability Plots to Assess Normality}}{}}\label{section-21}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Creating Probability Plots}{ Creating Probability Plots}}\label{creating-probability-plots}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Creating Probability Plots}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Understanding Variability in Random Samples}{ Understanding Variability in Random Samples}}\label{understanding-variability-in-random-samples}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Understanding Variability in Random Samples}
...
\subsection{\texorpdfstring{\textcolor{blue}{ Transformations}}{}}\label{section-22}}

\hypertarget{transformations-for-anova}{%
\subsubsection*{Transformations for ANOVA}\label{transformations-for-anova}}
\addcontentsline{toc}{subsubsection}{Transformations for ANOVA}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Transforming Emissions Data}{ Transforming Emissions Data}}\label{transforming-emissions-data}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Transforming Emissions Data}
...
\subsubsection*{Back Transformations}\label{back-transformations}}
\addcontentsline{toc}{subsubsection}{Back Transformations}
...
\subsubsection*{Transformations for Regression}\label{transformations-for-regression}}
\addcontentsline{toc}{subsubsection}{Transformations for Regression}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Transforming Brain and Body Weight Data}{ Transforming Brain and Body Weight Data}}\label{transforming-brain-and-body-weight-data}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Transforming Brain and Body Weight Data}
...
\subsubsection*{Choosing the Right Transformation}\label{choosing-the-right-transformation}}
\addcontentsline{toc}{subsubsection}{Choosing the Right Transformation}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Comparing Four \(\scriptstyle (x, y)\) Data Sets}{ Comparing Four \textbackslash scriptstyle (x, y) Data Sets}}\label{comparing-four-scriptstyle-x-y-data-sets}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Comparing Four \(\scriptstyle (x, y)\) Data Sets}
...
\subsection{\texorpdfstring{\textcolor{blue}{ Calculating Test Statistics}}{}}\label{section-23}}
...
\subsubsection*{\texorpdfstring{The Two-Sample \(\scriptstyle t\)-Test with the Equal Variance Assumption}{The Two-Sample \textbackslash scriptstyle t-Test with the Equal Variance Assumption}}\label{the-two-sample-scriptstyle-t-test-with-the-equal-variance-assumption}}
\addcontentsline{toc}{subsubsection}{The Two-Sample \(\scriptstyle t\)-Test with the Equal Variance Assumption}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Calculating the Two-Sample t-Test}{ Calculating the Two-Sample t-Test}}\label{calculating-the-two-sample-t-test}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Calculating the Two-Sample t-Test}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Testing the Slope Coefficient}{ Testing the Slope Coefficient}}\label{testing-the-slope-coefficient}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Testing the Slope Coefficient}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Calculating an ANOVA Table}{ Calculating an ANOVA Table}}\label{calculating-an-anova-table}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Calculating an ANOVA Table}
...
\subsection{\texorpdfstring{\textcolor{blue}{ Confidence Intervals}}{}}\label{section-24}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Calculating a Confidence Interval for the Regression Coefficient}{ Calculating a Confidence Interval for the Regression Coefficient}}\label{calculating-a-confidence-interval-for-the-regression-coefficient}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Calculating a Confidence Interval for the Regression Coefficient}
...
\subsection{\texorpdfstring{\textcolor{blue}{ Chapter Summary}}{}}\label{section-25}}
...
\section{Multiple Regression: How Much Is Your Car Worth?}\label{multiple-regression-how-much-is-your-car-worth}}
...
\subsection{\texorpdfstring{\textcolor{blue}{Investigation: How Can We Build a Model to Estimate Used Car Prices?}}{}}\label{section-26}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} A Simple Linear Regression Model}{ A Simple Linear Regression Model}}\label{a-simple-linear-regression-model}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} A Simple Linear Regression Model}
...
\subsection{\texorpdfstring{\textcolor{blue}{Goals of Multiple Regression}}{}}\label{section-27}}
...
\subsection{\texorpdfstring{\textcolor{blue}{Variable Selection Techniques to Describe or Predict a Response}}{}}\label{section-28}}
...
\addcontentsline{toc}{subsubsection}{Stepwise Regression}
...
\subsubsection*{Selecting the ``Best Subset'' of Predictors}\label{selecting-the-best-subset-of-predictors}}
\addcontentsline{toc}{subsubsection}{Selecting the ``Best Subset'' of Predictors}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Comparing Variable Selection Techniques}{ Comparing Variable Selection Techniques}}\label{comparing-variable-selection-techniques}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Comparing Variable Selection Techniques}
...
\subsection{\texorpdfstring{\textcolor{blue}{Checking Model Assumptions}}{}}\label{section-29}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Heteroskedasticity}{ Heteroskedasticity}}\label{heteroskedasticity}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Heteroskedasticity}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:}Examining Residual Plots Across Time/Order}{Examining Residual Plots Across Time/Order}}\label{examining-residual-plots-across-timeorder}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:}Examining Residual Plots Across Time/Order}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Outliers and Influential Observations}{ Outliers and Influential Observations}}\label{outliers-and-influential-observations}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Outliers and Influential Observations}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Normally Distributed Residuals}{ Normally Distributed Residuals}}\label{normally-distributed-residuals}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Normally Distributed Residuals}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Correlation Between Explanatory Variables}{ Correlation Between Explanatory Variables}}\label{correlation-between-explanatory-variables}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Correlation Between Explanatory Variables}
...
\subsection{\texorpdfstring{\textcolor{blue}{Interpreting Model Coefficients}}{}}\label{section-30}}
...
\subsection{\texorpdfstring{\textcolor{blue}{Categorical Explanatory Variables}}{}}\label{section-31}}
...
\subsubsection*{Creating Indicator Variables}\label{creating-indicator-variables}}
\addcontentsline{toc}{subsubsection}{Creating Indicator Variables}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Building Regression Models with Indicator Variables}{ Building Regression Models with Indicator Variables}}\label{building-regression-models-with-indicator-variables}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Building Regression Models with Indicator Variables}
...
\subsection{\texorpdfstring{\textcolor{blue}{What Can We Conclude from the 2005 GM Car Study?}}{}}\label{section-32}}
...
\subsection{\texorpdfstring{\textcolor{blue}{F-Tests for Multiple Regression}}{}}\label{section-33}}

\hypertarget{decomposition-of-sum-of-squares}{%
\subsubsection*{Decomposition of Sum of Squares}\label{decomposition-of-sum-of-squares}}
\addcontentsline{toc}{subsubsection}{Decomposition of Sum of Squares}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} A Closer Look at Least Squares Regression Equations}{ A Closer Look at Least Squares Regression Equations}}\label{a-closer-look-at-least-squares-regression-equations}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} A Closer Look at Least Squares Regression Equations}
...
\subsubsection*{The Analysis of Variance Table}\label{the-analysis-of-variance-table}}
\addcontentsline{toc}{subsubsection}{The Analysis of Variance Table}
...
\subsubsection*{Testing the Significance of a Regression Model}\label{testing-the-significance-of-a-regression-model}}
\addcontentsline{toc}{subsubsection}{Testing the Significance of a Regression Model}
...
\subsubsection*{\texorpdfstring{The Extra Sum of Squares \(\scriptstyle F\)-Test}{The Extra Sum of Squares \textbackslash scriptstyle F-Test}}\label{the-extra-sum-of-squares-scriptstyle-f-test}}
\addcontentsline{toc}{subsubsection}{The Extra Sum of Squares \(\scriptstyle F\)-Test}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Testing Multiple Coefficients}{ Testing Multiple Coefficients}}\label{testing-multiple-coefficients}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Testing Multiple Coefficients}
...
\subsection{\texorpdfstring{\textcolor{blue}{Developing a Model to Confirm a Theory}}{}}\label{section-34}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Testing a Theory on Cars}{ Testing a Theory on Cars}}\label{testing-a-theory-on-cars}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Testing a Theory on Cars}
...
\subsection{\texorpdfstring{\textcolor{blue}{Interaction and Terms for Curvature}}{}}\label{section-35}}
...
\addcontentsline{toc}{subsubsection}{Interaction Terms}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Understanding Interaction Terms}{ Understanding Interaction Terms}}\label{understanding-interaction-terms}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Understanding Interaction Terms}
...
\subsubsection*{Quadratic and Cubic Terms}\label{quadratic-and-cubic-terms}}
\addcontentsline{toc}{subsubsection}{Quadratic and Cubic Terms}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Understanding Quadratic Terms}{ Understanding Quadratic Terms}}\label{understanding-quadratic-terms}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Understanding Quadratic Terms}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Creating New Terms to Predict the Retail Price of Cars}{ Creating New Terms to Predict the Retail Price of Cars}}\label{creating-new-terms-to-predict-the-retail-price-of-cars}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Creating New Terms to Predict the Retail Price of Cars}
...
\subsection{\texorpdfstring{\textcolor{blue}{A Closer Look at Variable Selection Criteria}}{}}\label{section-36}}
...
\subsubsection*{\texorpdfstring{Adjusted \(\scriptstyle {R}^2\)}{Adjusted \textbackslash scriptstyle \{R\}\^{}2}}\label{adjusted-scriptstyle-r2}}
\addcontentsline{toc}{subsubsection}{Adjusted \(\scriptstyle {R}^2\)}
...
\subsubsection*{\texorpdfstring{Mallows' \(\scriptstyle C_p\)}{Mallows' \textbackslash scriptstyle C\_p}}\label{mallows-scriptstyle-c_p}}
\addcontentsline{toc}{subsubsection}{Mallows' \(\scriptstyle C_p\)}
...
\subsubsection*{Akaike's Information Criterion (AIC) and Bayes' Information Criterion (BIC)}\label{akaikes-information-criterion-aic-and-bayes-information-criterion-bic}}
\addcontentsline{toc}{subsubsection}{Akaike's Information Criterion (AIC) and Bayes' Information Criterion (BIC)}
...
\addcontentsline{toc}{subsubsection}{Model Validation}
...
\subsection{\texorpdfstring{\textcolor{blue}{Chapter Summary}}{}}\label{section-37}}
...
\subsubsection*{Endnotes}\label{endnotes-1}}
\addcontentsline{toc}{subsubsection}{Endnotes}
...
\section{The Design and Analysis of Factorial Experiments: Popcorn and Paper Towels}\label{the-design-and-analysis-of-factorial-experiments-popcorn-and-paper-towels}}
...
\subsection{\texorpdfstring{\textcolor{blue}{Investigation: Which Microwave Popcorn Is the Best?}}{}}\label{section-38}}
...
\subsection{\texorpdfstring{\textcolor{blue}{Elements of a Well-Designed Experiment}}{}}\label{section-39}}
...
\subsubsection*{Identifying a Response Variable}\label{identifying-a-response-variable}}
\addcontentsline{toc}{subsubsection}{Identifying a Response Variable}
...
\subsubsection*{Identifying the Factors and Levels}\label{identifying-the-factors-and-levels}}
\addcontentsline{toc}{subsubsection}{Identifying the Factors and Levels}
...
\subsubsection*{Choosing a Design}\label{choosing-a-design}}
\addcontentsline{toc}{subsubsection}{Choosing a Design}
...
\subsubsection*{Determining Sample Sizes for Completely Randomized Designs}\label{determining-sample-sizes-for-completely-randomized-designs}}
\addcontentsline{toc}{subsubsection}{Determining Sample Sizes for Completely Randomized Designs}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Determining the Number of Treatment Combinations}{ Determining the Number of Treatment Combinations}}\label{determining-the-number-of-treatment-combinations}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Determining the Number of Treatment Combinations}
...
\subsection{\texorpdfstring{\textcolor{blue}{Analyzing a Two-Way Factorial Design}}{}}\label{section-40}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Visualizing the Data}{ Visualizing the Data}}\label{visualizing-the-data}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Visualizing the Data}
...
\subsubsection*{Notation for Multiple Explanatory Variables}\label{notation-for-multiple-explanatory-variables}}
\addcontentsline{toc}{subsubsection}{Notation for Multiple Explanatory Variables}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Understanding Notation}{ Understanding Notation}}\label{understanding-notation}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Understanding Notation}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Calculating F-Statistics}{ Calculating F-Statistics}}\label{calculating-f-statistics}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Calculating F-Statistics}
...
\subsubsection*{Interpreting Interaction Terms}\label{interpreting-interaction-terms}}
\addcontentsline{toc}{subsubsection}{Interpreting Interaction Terms}
...
\subsection{\texorpdfstring{\textcolor{blue}{Analyzing a Three-Way Factorial Design}}{}}\label{section-41}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Conducting a Three-Way ANOVA}{ Conducting a Three-Way ANOVA}}\label{conducting-a-three-way-anova}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Conducting a Three-Way ANOVA}
...
\subsection{\texorpdfstring{\textcolor{blue}{What Can We Conclude from the Popcorn Study?}}{}}\label{section-42}}
...
\subsection{\texorpdfstring{\textcolor{blue}{Paper Towels: Developing a Statistical Model for a Two-Way Factorial Design}}{}}\label{section-43}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Algebraic Notation}{ Algebraic Notation}}\label{algebraic-notation}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Algebraic Notation}
...
\subsubsection*{Calculating Effects}\label{calculating-effects}}
\addcontentsline{toc}{subsubsection}{Calculating Effects}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Estimating Main Effects}{ Estimating Main Effects}}\label{estimating-main-effects}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Estimating Main Effects}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Calculating Interaction Effects}{ Calculating Interaction Effects}}\label{calculating-interaction-effects}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Calculating Interaction Effects}
...
\subsection{\texorpdfstring{\textcolor{blue}{Paper Towels: The Relationship Between Effects and ANOVA}}{}}\label{section-44}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Calculating Degrees of Freedom for Interaction Terms}{ Calculating Degrees of Freedom for Interaction Terms}}\label{calculating-degrees-of-freedom-for-interaction-terms}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Calculating Degrees of Freedom for Interaction Terms}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Analyzing the Paper Towel Data}{ Analyzing the Paper Towel Data}}\label{analyzing-the-paper-towel-data}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Analyzing the Paper Towel Data}
...
\subsection{\texorpdfstring{\textcolor{blue}{Contrasts and Multiple Comparisons}}{}}\label{section-45}}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:}Comparing One-Way and Two-Way ANOVA}{Comparing One-Way and Two-Way ANOVA}}\label{comparing-one-way-and-two-way-anova}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:}Comparing One-Way and Two-Way ANOVA}
...
\subsubsection*{\texorpdfstring{\textcolor{blue}{Practice:} Calculating Contrasts}{ Calculating Contrasts}}\label{calculating-contrasts}}
\addcontentsline{toc}{subsubsection}{\textcolor{blue}{Practice:} Calculating Contrasts}
...
\subsection{\texorpdfstring{\textcolor{blue}{Chapter Summary}}{}}\label{section-46}}
...
\subsubsection*{Endnotes}\label{endnotes-2}}
\addcontentsline{toc}{subsubsection}{Endnotes}
...
\section{Categorical Data Analysis: Is a Tumor Malignant or Benign?}\label{categorical-data-analysis-is-a-tumor-malignant-or-benign}}
...
\subsection{Investigation: Is Cell Shape Associated with Malignancy?}\label{investigation-is-cell-shape-associated-with-malignancy}}
...
\subsubsection*{Activity: Descriptive Statistics and Graphs}\label{activity-descriptive-statistics-and-graphs}}
\addcontentsline{toc}{subsubsection}{Activity: Descriptive Statistics and Graphs}
...
\subsection{A Simulation Study: How Likely Is It That the Observed Sample Would Occur by Chance?}\label{a-simulation-study-how-likely-is-it-that-the-observed-sample-would-occur-by-chance}}
...
\subsubsection*{Activity: Conducting a Simulation Study with Cards}\label{activity-conducting-a-simulation-study-with-cards}}
\addcontentsline{toc}{subsubsection}{Activity: Conducting a Simulation Study with Cards}
...
\subsubsection*{Activity: Computer Simulation}\label{activity-computer-simulation}}
\addcontentsline{toc}{subsubsection}{Activity: Computer Simulation}
...
\subsubsection*{Activity: Calculating Fisher's Exact Test}\label{activity-calculating-fishers-exact-test}}
\addcontentsline{toc}{subsubsection}{Activity: Calculating Fisher's Exact Test}
...
\subsection{Two-Sided Hypothesis Tests}\label{two-sided-hypothesis-tests}}
...
\subsubsection*{Activity: Calculating a Two-Sided Hypothesis Test}\label{activity-calculating-a-two-sided-hypothesis-test}}
\addcontentsline{toc}{subsubsection}{Activity: Calculating a Two-Sided Hypothesis Test}
...
\subsubsection*{Activity: Calculating Expected Counts}\label{activity-calculating-expected-counts}}
\addcontentsline{toc}{subsubsection}{Activity: Calculating Expected Counts}
...
\subsubsection*{Activity: Conducting a Chi-Square Test}\label{activity-conducting-a-chi-square-test}}
\addcontentsline{toc}{subsubsection}{Activity: Conducting a Chi-Square Test}
...
\subsubsection*{Activity: Simulating the Chi-Square Test Statistic}\label{activity-simulating-the-chi-square-test-statistic}}
\addcontentsline{toc}{subsubsection}{Activity: Simulating the Chi-Square Test Statistic}
...
\subsection{What Can We Conclude from the Cancer Study?}\label{what-can-we-conclude-from-the-cancer-study}}
...
\subsection{Relative Risk and the Odds Ratio}\label{relative-risk-and-the-odds-ratio}}
...
\subsubsection*{Activity: Calculating Additional Summary Statistics}\label{activity-calculating-additional-summary-statistics}}
\addcontentsline{toc}{subsubsection}{Activity: Calculating Additional Summary Statistics}
...
\subsubsection*{Cautions About Relative Risk Reduction in Medical Studies}\label{cautions-about-relative-risk-reduction-in-medical-studies}}
\addcontentsline{toc}{subsubsection}{Cautions About Relative Risk Reduction in Medical Studies}
...
\subsubsection*{Activity: Comparing Relative and Absolute Risk Reduction}\label{activity-comparing-relative-and-absolute-risk-reduction}}
\addcontentsline{toc}{subsubsection}{Activity: Comparing Relative and Absolute Risk Reduction}
...
\subsubsection*{Activity: Retrospective Studies and the Odds Ratio}\label{activity-retrospective-studies-and-the-odds-ratio}}
\addcontentsline{toc}{subsubsection}{Activity: Retrospective Studies and the Odds Ratio}
...
\subsubsection*{Tests for the Homogeneity of Odds}\label{tests-for-the-homogeneity-of-odds}}
\addcontentsline{toc}{subsubsection}{Tests for the Homogeneity of Odds}
...
\subsection{Comparing Tests of Homogeneity and Independence}\label{comparing-tests-of-homogeneity-and-independence}}
...
\subsubsection*{Activity: Playing a Dice Game}\label{activity-playing-a-dice-game}}
\addcontentsline{toc}{subsubsection}{Activity: Playing a Dice Game}
...
\subsubsection*{Endnotes}\label{endnotes-3}}
\addcontentsline{toc}{subsubsection}{Endnotes}
...
\section{Logistic Regression: The Space Shuttle Challenger}\label{logistic-regression-the-space-shuttle-challenger}}
...
\subsection{Investigation: Did Temperature Influence the Likelihood of an O-Ring Failure?}\label{investigation-did-temperature-influence-the-likelihood-of-an-o-ring-failure}}
...
\subsubsection*{Activity: Describing the Data}\label{activity-describing-the-data}}
\addcontentsline{toc}{subsubsection}{Activity: Describing the Data}
...
\subsection{Review of the Least Squares Regression Model}\label{review-of-the-least-squares-regression-model}}
...
\subsubsection*{Activity: Building a Least Squares Regression Model}\label{activity-building-a-least-squares-regression-model}}
\addcontentsline{toc}{subsubsection}{Activity: Building a Least Squares Regression Model}
...
\subsection{The Logistic Regression Model}\label{the-logistic-regression-model}}
...
\subsection{The Logistic Regression Model Using Maximum Likelihood Estimates}\label{the-logistic-regression-model-using-maximum-likelihood-estimates}}
...
\subsubsection*{Activity: Using Software to Calculate Maximum Likelihood Estimates}\label{activity-using-software-to-calculate-maximum-likelihood-estimates}}
\addcontentsline{toc}{subsubsection}{Activity: Using Software to Calculate Maximum Likelihood Estimates}
...
\subsubsection*{Activity: Estimating the Probability of Success with Maximum Likelihood Estimates}\label{activity-estimating-the-probability-of-success-with-maximum-likelihood-estimates}}
\addcontentsline{toc}{subsubsection}{Activity: Estimating the Probability of Success with Maximum Likelihood Estimates}
...
\subsection{Interpreting the Logistic Regression Model}\label{interpreting-the-logistic-regression-model}}
...
\subsubsection*{Activity: Interpreting a Logistic Regression Model}\label{activity-interpreting-a-logistic-regression-model}}
\addcontentsline{toc}{subsubsection}{Activity: Interpreting a Logistic Regression Model}
...
\subsection{Inference for the Logistic Regression Model}\label{inference-for-the-logistic-regression-model}}

\hypertarget{assumptions-for-logistic-regression-models}{%
\subsubsection*{Assumptions for Logistic Regression Models}\label{assumptions-for-logistic-regression-models}}
\addcontentsline{toc}{subsubsection}{Assumptions for Logistic Regression Models}
...
\subsubsection*{The Wald Statistic}\label{the-wald-statistic}}
\addcontentsline{toc}{subsubsection}{The Wald Statistic}
...
\subsubsection*{Activity: Wald Confidence Intervals and Hypothesis Tests}\label{activity-wald-confidence-intervals-and-hypothesis-tests}}
\addcontentsline{toc}{subsubsection}{Activity: Wald Confidence Intervals and Hypothesis Tests}
...
\subsubsection*{The Likelihood Ratio Test}\label{the-likelihood-ratio-test}}
\addcontentsline{toc}{subsubsection}{The Likelihood Ratio Test}
...
\subsubsection*{Activity: The Likelihood Ratio Test}\label{activity-the-likelihood-ratio-test}}
\addcontentsline{toc}{subsubsection}{Activity: The Likelihood Ratio Test}
...
\subsection{What Can We Conclude from the Space Shuttle Study?}\label{what-can-we-conclude-from-the-space-shuttle-study}}
...
\subsection{Logistic Regression with Multiple Explanatory Variables}\label{logistic-regression-with-multiple-explanatory-variables}}
...
\subsubsection*{Activity: Estimating the Probability of Malignancy in Cancer Cells}\label{activity-estimating-the-probability-of-malignancy-in-cancer-cells}}
\addcontentsline{toc}{subsubsection}{Activity: Estimating the Probability of Malignancy in Cancer Cells}
...
\subsection{The Drop-in-Deviance Test}\label{the-drop-in-deviance-test}}
...
\subsubsection*{Activity: Measures of Association}\label{activity-measures-of-association}}
\addcontentsline{toc}{subsubsection}{Activity: Measures of Association}
...
\subsection{Review of Means and Variances of Binary and Binomial Data}\label{review-of-means-and-variances-of-binary-and-binomial-data}}
...
\subsubsection*{Activity: Understanding the Binomial Distribution}\label{activity-understanding-the-binomial-distribution}}
\addcontentsline{toc}{subsubsection}{Activity: Understanding the Binomial Distribution}
...
\subsection{Calculating Logistic Regression Models for Binomial Counts}\label{calculating-logistic-regression-models-for-binomial-counts}}
...
\subsubsection*{Activity: Binomial Logistic Regression}\label{activity-binomial-logistic-regression}}
\addcontentsline{toc}{subsubsection}{Activity: Binomial Logistic Regression}
...
\subsection{Calculating Residuals for Logistic Models with Binomial Counts}\label{calculating-residuals-for-logistic-models-with-binomial-counts}}
...
\subsubsection*{Activity: Evaluating Residuals in Binomial Logistic Regression}\label{activity-evaluating-residuals-in-binomial-logistic-regression}}
\addcontentsline{toc}{subsubsection}{Activity: Evaluating Residuals in Binomial Logistic Regression}
...
\subsection{Assessing the Fit of a Logistic Regression Model with Binomial Counts}\label{assessing-the-fit-of-a-logistic-regression-model-with-binomial-counts}}
...
\subsubsection*{Activity: Calculating Residuals by Hand}\label{activity-calculating-residuals-by-hand}}
\addcontentsline{toc}{subsubsection}{Activity: Calculating Residuals by Hand}
...
\subsubsection*{Activity: Goodness‐of‐Fit Tests for Continuous Explanatory Variables}\label{activity-goodnessoffit-tests-for-continuous-explanatory-variables}}
\addcontentsline{toc}{subsubsection}{Activity: Goodness‐of‐Fit Tests for Continuous Explanatory Variables}
...
\subsubsection*{Activity: Goodness‐of‐Fit Tests for Continuous Explanatory Variables}\label{activity-goodnessoffit-tests-for-continuous-explanatory-variables-1}}
\addcontentsline{toc}{subsubsection}{Activity: Goodness‐of‐Fit Tests for Continuous Explanatory Variables}
...
\subsubsection*{Activity: Identifying Outliers and Influential Observations}\label{activity-identifying-outliers-and-influential-observations}}
\addcontentsline{toc}{subsubsection}{Activity: Identifying Outliers and Influential Observations}
...
\subsection{Maximum Likelihood Estimation in Logistic Regression}\label{maximum-likelihood-estimation-in-logistic-regression}}
...
\subsubsection*{Maximum Likelihood Estimator for Binary Data}\label{maximum-likelihood-estimator-for-binary-data}}
\addcontentsline{toc}{subsubsection}{Maximum Likelihood Estimator for Binary Data}
...
\subsubsection*{Activity: Calculating Maximum Likelihood Estimates}\label{activity-calculating-maximum-likelihood-estimates}}
\addcontentsline{toc}{subsubsection}{Activity: Calculating Maximum Likelihood Estimates}
...
\subsubsection*{Maximum Likelihood Estimator for Logistic Regression Models}\label{maximum-likelihood-estimator-for-logistic-regression-models}}
\addcontentsline{toc}{subsubsection}{Maximum Likelihood Estimator for Logistic Regression Models}
...
\subsubsection*{Endnotes}\label{endnotes-4}}
\addcontentsline{toc}{subsubsection}{Endnotes}
...
\section{Survival Analysis: Melting Chocolate Chips}\label{survival-analysis-melting-chocolate-chips}}
...
\subsection{Investigation: How Long Does It Take for Chocolate Chips to Melt?}\label{investigation-how-long-does-it-take-for-chocolate-chips-to-melt}}
...
\subsubsection*{Activity: Melting Chocolate Chips}\label{activity-melting-chocolate-chips}}
\addcontentsline{toc}{subsubsection}{Activity: Melting Chocolate Chips}
...
\subsection{Overview of Survival Analysis Studies and Data}\label{overview-of-survival-analysis-studies-and-data}}
...
\subsubsection*{Incomplete Event Times: Censoring}\label{incomplete-event-times-censoring}}
\addcontentsline{toc}{subsubsection}{Incomplete Event Times: Censoring}
...
\subsubsection*{Activity: Melting Chocolate Chips}\label{activity-melting-chocolate-chips-1}}
\addcontentsline{toc}{subsubsection}{Activity: Melting Chocolate Chips}
...
\subsection{The Survival Function}\label{the-survival-function}}
...
\subsubsection*{The Empirical Survival Function}\label{the-empirical-survival-function}}
\addcontentsline{toc}{subsubsection}{The Empirical Survival Function}
...
\subsubsection*{Activity: Empirical Survival Function}\label{activity-empirical-survival-function}}
\addcontentsline{toc}{subsubsection}{Activity: Empirical Survival Function}
...
\subsubsection*{The Kaplan--Meier Estimator}\label{the-kaplanmeier-estimator}}
\addcontentsline{toc}{subsubsection}{The Kaplan--Meier Estimator}
...
\subsubsection*{Activity: Time Intervals for the Chip Melting Times}\label{activity-time-intervals-for-the-chip-melting-times}}
\addcontentsline{toc}{subsubsection}{Activity: Time Intervals for the Chip Melting Times}
...
\subsubsection*{Activity: Estimated Conditional Melting Probabilities}\label{activity-estimated-conditional-melting-probabilities}}
\addcontentsline{toc}{subsubsection}{Activity: Estimated Conditional Melting Probabilities}
...
\subsubsection*{Activity: Kaplan--Meier Estimates}\label{activity-kaplanmeier-estimates}}
\addcontentsline{toc}{subsubsection}{Activity: Kaplan--Meier Estimates}
...
\subsubsection*{Graphing the Kaplan--Meier Curve}\label{graphing-the-kaplanmeier-curve}}
\addcontentsline{toc}{subsubsection}{Graphing the Kaplan--Meier Curve}
...
\subsubsection*{Activity: Kaplan--Meier Curves}\label{activity-kaplanmeier-curves}}
\addcontentsline{toc}{subsubsection}{Activity: Kaplan--Meier Curves}
...
\subsubsection*{Additional Chip Melting Experiences}\label{additional-chip-melting-experiences}}
\addcontentsline{toc}{subsubsection}{Additional Chip Melting Experiences}
...
\subsubsection*{Activity: Chip Melting Experiences}\label{activity-chip-melting-experiences}}
\addcontentsline{toc}{subsubsection}{Activity: Chip Melting Experiences}
...
\subsection{Descriptive Statistics for Survival Data}\label{descriptive-statistics-for-survival-data}}
...
\subsubsection*{Estimating the Mean Survival Time}\label{estimating-the-mean-survival-time}}
\addcontentsline{toc}{subsubsection}{Estimating the Mean Survival Time}
...
\subsubsection*{Activity: Estimated Mean Chip Melting Time}\label{activity-estimated-mean-chip-melting-time}}
\addcontentsline{toc}{subsubsection}{Activity: Estimated Mean Chip Melting Time}
...
\subsubsection*{Estimating Percentiles of the Survival Time Distribution}\label{estimating-percentiles-of-the-survival-time-distribution}}
\addcontentsline{toc}{subsubsection}{Estimating Percentiles of the Survival Time Distribution}
...
\subsubsection*{Activity: Estimated Median Chip Melting Time}\label{activity-estimated-median-chip-melting-time}}
\addcontentsline{toc}{subsubsection}{Activity: Estimated Median Chip Melting Time}
...
\subsection{Confidence Intervals for Survival Probabilities}\label{confidence-intervals-for-survival-probabilities}}
...
\subsubsection*{The Standard Error of the Kaplan--Meier Estimator}\label{the-standard-error-of-the-kaplanmeier-estimator}}
\addcontentsline{toc}{subsubsection}{The Standard Error of the Kaplan--Meier Estimator}
...
\subsubsection*{Activity: Standard Errors and Confidence Intervals for Survival Probabilities}\label{activity-standard-errors-and-confidence-intervals-for-survival-probabilities}}
\addcontentsline{toc}{subsubsection}{Activity: Standard Errors and Confidence Intervals for Survival Probabilities}
...
\subsection{Comparing Survival Functions}\label{comparing-survival-functions}}
...
\subsubsection*{The Log-Rank Test}\label{the-log-rank-test}}
\addcontentsline{toc}{subsubsection}{The Log-Rank Test}
...
\subsubsection*{Activity: Calculating the Expected Number and Variance of Melted Chips}\label{activity-calculating-the-expected-number-and-variance-of-melted-chips}}
\addcontentsline{toc}{subsubsection}{Activity: Calculating the Expected Number and Variance of Melted Chips}
...
\subsubsection*{Activity: Log-Rank Test Statistic}\label{activity-log-rank-test-statistic}}
\addcontentsline{toc}{subsubsection}{Activity: Log-Rank Test Statistic}
...
\subsubsection*{Activity: Log-Rank Test for Chip Melting Activity}\label{activity-log-rank-test-for-chip-melting-activity}}
\addcontentsline{toc}{subsubsection}{Activity: Log-Rank Test for Chip Melting Activity}
...
\subsubsection*{The Wilcoxon Test}\label{the-wilcoxon-test}}
\addcontentsline{toc}{subsubsection}{The Wilcoxon Test}
...
\subsubsection*{Beyond Different Survival Experiences: Regression Models for Survival Data}\label{beyond-different-survival-experiences-regression-models-for-survival-data}}
\addcontentsline{toc}{subsubsection}{Beyond Different Survival Experiences: Regression Models for Survival Data}
...
\subsection{What Can We Conclude About Melting Chocolate Chips?}\label{what-can-we-conclude-about-melting-chocolate-chips}}
...
\subsubsection*{The Population Hazard Function}\label{the-population-hazard-function}}
\addcontentsline{toc}{subsubsection}{The Population Hazard Function}
...
\subsubsection*{The Estimated Hazard Function}\label{the-estimated-hazard-function}}
\addcontentsline{toc}{subsubsection}{The Estimated Hazard Function}
...
\subsubsection*{Activity: Chip Melting Hazard Rates}\label{activity-chip-melting-hazard-rates}}
\addcontentsline{toc}{subsubsection}{Activity: Chip Melting Hazard Rates}
...
\subsubsection*{Activity: Estimated Hazard Rates}\label{activity-estimated-hazard-rates}}
\addcontentsline{toc}{subsubsection}{Activity: Estimated Hazard Rates}
...
\subsubsection*{Age at First Alcoholic Drink}\label{age-at-first-alcoholic-drink}}
\addcontentsline{toc}{subsubsection}{Age at First Alcoholic Drink}
...
\subsubsection*{Activity: Age at First Alcoholic Drink}\label{activity-age-at-first-alcoholic-drink}}
\addcontentsline{toc}{subsubsection}{Activity: Age at First Alcoholic Drink}
...
\subsubsection*{College Graduation}\label{college-graduation}}
\addcontentsline{toc}{subsubsection}{College Graduation}
...
\subsubsection*{Activity: College Graduation}\label{activity-college-graduation}}
\addcontentsline{toc}{subsubsection}{Activity: College Graduation}
...
\subsection{The Cumulative Hazard Function}\label{the-cumulative-hazard-function}}
...
\subsubsection*{Motorist Reaction Times}\label{motorist-reaction-times}}
\addcontentsline{toc}{subsubsection}{Motorist Reaction Times}
...
\subsubsection*{Estimator of the Cumulative Hazard Function}\label{estimator-of-the-cumulative-hazard-function}}
\addcontentsline{toc}{subsubsection}{Estimator of the Cumulative Hazard Function}
...
\subsubsection*{Activity: Estimated Cumulative Hazard Function}\label{activity-estimated-cumulative-hazard-function}}
\addcontentsline{toc}{subsubsection}{Activity: Estimated Cumulative Hazard Function}
...
\subsubsection*{Time to Rearrest for Former Inmates}\label{time-to-rearrest-for-former-inmates}}
\addcontentsline{toc}{subsubsection}{Time to Rearrest for Former Inmates}
...
\subsubsection*{Extended Activity: Estimated Cumulative Hazard Function}\label{extended-activity-estimated-cumulative-hazard-function}}
\addcontentsline{toc}{subsubsection}{Extended Activity: Estimated Cumulative Hazard Function}
...
\subsection{Additional Types of Incomplete Data}\label{additional-types-of-incomplete-data}}
...
\subsubsection*{Left Censoring and Interval Censoring}\label{left-censoring-and-interval-censoring}}
\addcontentsline{toc}{subsubsection}{Left Censoring and Interval Censoring}
...
\subsubsection*{Activity: Left Censoring and Interval Censoring}\label{activity-left-censoring-and-interval-censoring}}
\addcontentsline{toc}{subsubsection}{Activity: Left Censoring and Interval Censoring}
...
\subsubsection{Chapter Summary}\label{chapter-summary-2}}
...
\subsubsection*{Endnotes}\label{endnotes-5}}
\addcontentsline{toc}{subsubsection}{Endnotes}
