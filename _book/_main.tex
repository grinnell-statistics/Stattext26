...
{\centering \includegraphics[width=1.1\linewidth]{docs/Fig7_5Minitab} 
...
{\centering \includegraphics[width=1.1\linewidth]{docs/Fig7_6} 
...
{\centering \includegraphics[width=1.1\linewidth]{docs/Fig7_7} 
...
{\centering \includegraphics[width=1.1\linewidth]{docs/Fig7_9} 
...
\hypertarget{goodnessoffit-tests-for-continuous-explanatory-variables}{%
\subsection*{\texorpdfstring{\textcolor{blue}{Practice:} Goodness‐of‐Fit Tests for Continuous Explanatory Variables}{ Goodness‐of‐Fit Tests for Continuous Explanatory Variables}}\label{goodnessoffit-tests-for-continuous-explanatory-variables}}
...
\hypertarget{goodnessoffit-tests-for-continuous-explanatory-variables-1}{%
\subsection*{\texorpdfstring{\textcolor{blue}{Practice:} Goodness‐of‐Fit Tests for Continuous Explanatory Variables}{ Goodness‐of‐Fit Tests for Continuous Explanatory Variables}}\label{goodnessoffit-tests-for-continuous-explanatory-variables-1}}
\addcontentsline{toc}{subsection}{\textcolor{blue}{Practice:} Goodness‐of‐Fit Tests for Continuous Explanatory Variables}
...
{\centering \includegraphics[width=0.8\linewidth]{docs/Fig7_12} 
