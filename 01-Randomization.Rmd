...
# \textcolor{blue}{Nonparametric Methods: Schistosomiasis}
...
* A **bootstrap t confidence interval** is found by calculating $\scriptstyle \bar{x}$ $\scriptstyle \pm t^*(S^*)$ where $\scriptstyle S^*$ is the standard
