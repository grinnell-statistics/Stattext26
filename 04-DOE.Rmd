...
```{r fig1, warning=FALSE, echo=FALSE, fig.width=3.5, message=FALSE, fig.cap="Individual value plot of the PopRate (100 $\times$ count of popped kernels/total kernels) for each Brand and cooking Time factor-level combination. Points have jittering (small fluctuations) so that all values are visible."}
library(ggplot2)
